var q0,M,d0,J1,c,b0,h0,g0,F0,Q0,t,c0,M0,T0,_0,P1,X0={},G0=[],U1=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,z0=Array.isArray;function h(Z,Y){for(var O in Y)Z[O]=Y[O];return Z}function D0(Z){Z&&Z.parentNode&&Z.parentNode.removeChild(Z)}function H0(Z,Y,O){var W,G,Q,K={};for(Q in Y)Q=="key"?W=Y[Q]:Q=="ref"?G=Y[Q]:K[Q]=Y[Q];if(arguments.length>2&&(K.children=arguments.length>3?q0.call(arguments,2):O),typeof Z=="function"&&Z.defaultProps!=null)for(Q in Z.defaultProps)K[Q]===void 0&&(K[Q]=Z.defaultProps[Q]);return W0(Z,K,W,G,null)}function W0(Z,Y,O,W,G){var Q={type:Z,props:Y,key:O,ref:W,__k:null,__:null,__b:0,__e:null,__c:null,constructor:void 0,__v:G==null?++d0:G,__i:-1,__u:0};return G==null&&M.vnode!=null&&M.vnode(Q),Q}function N0(Z){return Z.children}function o(Z,Y){this.props=Z,this.context=Y}function a(Z,Y){if(Y==null)return Z.__?a(Z.__,Z.__i+1):null;for(var O;Y<Z.__k.length;Y++)if((O=Z.__k[Y])!=null&&O.__e!=null)return O.__e;return typeof Z.type=="function"?a(Z):null}function F1(Z){if(Z.__P&&Z.__d){var Y=Z.__v,O=Y.__e,W=[],G=[],Q=h({},Y);Q.__v=Y.__v+1,M.vnode&&M.vnode(Q),R0(Z.__P,Q,Y,Z.__n,Z.__P.namespaceURI,32&Y.__u?[O]:null,W,O==null?a(Y):O,!!(32&Y.__u),G),Q.__v=Y.__v,Q.__.__k[Q.__i]=Q,o0(W,Q,G),Y.__e=Y.__=null,Q.__e!=O&&p0(Q)}}function p0(Z){if((Z=Z.__)!=null&&Z.__c!=null)return Z.__e=Z.__c.base=null,Z.__k.some(function(Y){if(Y!=null&&Y.__e!=null)return Z.__e=Z.__c.base=Y.__e}),p0(Z)}function v0(Z){(!Z.__d&&(Z.__d=!0)&&c.push(Z)&&!K0.__r++||b0!=M.debounceRendering)&&((b0=M.debounceRendering)||h0)(K0)}function K0(){try{for(var Z,Y=1;c.length;)c.length>Y&&c.sort(g0),Z=c.shift(),Y=c.length,F1(Z)}finally{c.length=K0.__r=0}}function a0(Z,Y,O,W,G,Q,K,z,N,q,$){var P,X,H,V,U,D,R=W&&W.__k||G0,F=Y.length;for(N=T1(O,Y,R,N,F),P=0;P<F;P++)(H=O.__k[P])!=null&&(X=H.__i!=-1&&R[H.__i]||X0,H.__i=P,D=R0(Z,H,X,G,Q,K,z,N,q,$),V=H.__e,H.ref&&X.ref!=H.ref&&(X.ref&&w0(X.ref,null,H),$.push(H.ref,H.__c||V,H)),U==null&&V!=null&&(U=V),4&H.__u?(N=r0(H,N,Z),X.__e&&(X.__e=null)):typeof H.type=="function"&&D!==void 0?N=D:V&&(N=V.nextSibling),H.__u&=-7);return O.__e=U,N}function T1(Z,Y,O,W,G){var Q,K,z,N,q,$=O.length,P=$,X=0;for(Z.__k=Array(G),Q=0;Q<G;Q++)(K=Y[Q])!=null&&typeof K!="boolean"&&typeof K!="function"?(typeof K=="string"||typeof K=="number"||typeof K=="bigint"||K.constructor==String?K=Z.__k[Q]=W0(null,K,null,null,null):z0(K)?K=Z.__k[Q]=W0(N0,{children:K},null,null,null):K.constructor===void 0&&K.__b>0?K=Z.__k[Q]=W0(K.type,K.props,K.key,K.ref?K.ref:null,K.__v):Z.__k[Q]=K,N=Q+X,K.__=Z,K.__b=Z.__b+1,z=null,(q=K.__i=_1(K,O,N,P))!=-1&&(P--,(z=O[q])&&(z.__u|=2)),z==null||z.__v==null?(q==-1&&(G>$?X--:G<$&&X++),typeof K.type!="function"&&(K.__u|=4)):q!=N&&(q==N-1?X--:q==N+1?X++:(q>N?X--:X++,K.__u|=4))):Z.__k[Q]=null;if(P)for(Q=0;Q<$;Q++)(z=O[Q])!=null&&(2&z.__u)==0&&(z.__e==W&&(W=a(z)),l0(z,z));return W}function r0(Z,Y,O){var W,G;if(typeof Z.type=="function"){for(W=Z.__k,G=0;W&&G<W.length;G++)W[G]&&(W[G].__=Z,Y=r0(W[G],Y,O));return Y}Z.__e!=Y&&(Y&&Z.type&&!Y.parentNode&&(Y=a(Z)),Y=O.insertBefore(Z.__e,Y||null));do Y=Y&&Y.nextSibling;while(Y!=null&&Y.nodeType==8);return Y}function _1(Z,Y,O,W){var G,Q,K,z=Z.key,N=Z.type,q=Y[O],$=q!=null&&(2&q.__u)==0;if(q===null&&z==null||$&&z==q.key&&N==q.type)return O;if(W>($?1:0)){for(G=O-1,Q=O+1;G>=0||Q<Y.length;)if((q=Y[K=G>=0?G--:Q++])!=null&&(2&q.__u)==0&&z==q.key&&N==q.type)return K}return-1}function m0(Z,Y,O){Y[0]=="-"?Z.setProperty(Y,O==null?"":O):Z[Y]=O==null?"":typeof O!="number"||U1.test(Y)?O:O+"px"}function O0(Z,Y,O,W,G){var Q,K;Y:if(Y=="style")if(typeof O=="string")Z.style.cssText=O;else{if(typeof W=="string"&&(Z.style.cssText=W=""),W)for(Y in W)O&&Y in O||m0(Z.style,Y,"");if(O)for(Y in O)W&&O[Y]==W[Y]||m0(Z.style,Y,O[Y])}else if(Y[0]=="o"&&Y[1]=="n")Q=Y!=(Y=Y.replace(c0,"$1")),K=Y.toLowerCase(),Y=K in Z||Y=="onFocusOut"||Y=="onFocusIn"?K.slice(2):Y.slice(2),Z.l||(Z.l={}),Z.l[Y+Q]=O,O?W?O[t]=W[t]:(O[t]=M0,Z.addEventListener(Y,Q?_0:T0,Q)):Z.removeEventListener(Y,Q?_0:T0,Q);else{if(G=="http://www.w3.org/2000/svg")Y=Y.replace(/xlink(H|:h)/,"h").replace(/sName$/,"s");else if(Y!="width"&&Y!="height"&&Y!="href"&&Y!="list"&&Y!="form"&&Y!="tabIndex"&&Y!="download"&&Y!="rowSpan"&&Y!="colSpan"&&Y!="role"&&Y!="popover"&&Y in Z)try{Z[Y]=O==null?"":O;break Y}catch(z){}typeof O=="function"||(O==null||O===!1&&Y[4]!="-"?Z.removeAttribute(Y):Z.setAttribute(Y,Y=="popover"&&O==1?"":O))}}function f0(Z){return function(Y){if(this.l){var O=this.l[Y.type+Z];if(Y[Q0]==null)Y[Q0]=M0++;else if(Y[Q0]<O[t])return;return O(M.event?M.event(Y):Y)}}}function R0(Z,Y,O,W,G,Q,K,z,N,q){var $,P,X,H,V,U,D,R,F,C,v,w,B,j,m,s,S=Y.type;if(Y.constructor!==void 0)return null;128&O.__u&&(N=!!(32&O.__u),Q=[z=Y.__e=O.__e]),($=M.__b)&&$(Y);Y:if(typeof S=="function"){P=K.length;try{if(F=Y.props,C=S.prototype&&S.prototype.render,v=($=S.contextType)&&W[$.__c],w=$?v?v.props.value:$.__:W,O.__c?R=(X=Y.__c=O.__c).__=X.__E:(C?Y.__c=X=new S(F,w):(Y.__c=X=new o(F,w),X.constructor=S,X.render=D1),v&&v.sub(X),X.state||(X.state={}),X.__n=W,H=X.__d=!0,X.__h=[],X._sb=[]),C&&X.__s==null&&(X.__s=X.state),C&&S.getDerivedStateFromProps!=null&&(X.__s==X.state&&(X.__s=h({},X.__s)),h(X.__s,S.getDerivedStateFromProps(F,X.__s))),V=X.props,U=X.state,X.__v=Y,H)C&&S.getDerivedStateFromProps==null&&X.componentWillMount!=null&&X.componentWillMount(),C&&X.componentDidMount!=null&&X.__h.push(X.componentDidMount);else{if(C&&S.getDerivedStateFromProps==null&&F!==V&&X.componentWillReceiveProps!=null&&X.componentWillReceiveProps(F,w),Y.__v==O.__v||!X.__e&&X.shouldComponentUpdate!=null&&X.shouldComponentUpdate(F,X.__s,w)===!1){Y.__v!=O.__v&&(X.props=F,X.state=X.__s,X.__d=!1),Y.__e=O.__e,Y.__k=O.__k,Y.__k.some(function(g){g&&(g.__=Y)}),G0.push.apply(X.__h,X._sb),X._sb=[],X.__h.length&&K.push(X),z=a(O);break Y}X.componentWillUpdate!=null&&X.componentWillUpdate(F,X.__s,w),C&&X.componentDidUpdate!=null&&X.__h.push(function(){X.componentDidUpdate(V,U,D)})}if(X.context=w,X.props=F,X.__P=Z,X.__e=!1,B=M.__r,j=0,C)X.state=X.__s,X.__d=!1,B&&B(Y),$=X.render(X.props,X.state,X.context),G0.push.apply(X.__h,X._sb),X._sb=[];else do X.__d=!1,B&&B(Y),$=X.render(X.props,X.state,X.context),X.state=X.__s;while(X.__d&&++j<25);X.state=X.__s,X.getChildContext!=null&&(W=h(h({},W),X.getChildContext())),C&&!H&&X.getSnapshotBeforeUpdate!=null&&(D=X.getSnapshotBeforeUpdate(V,U)),m=$!=null&&$.type===N0&&$.key==null?s0($.props.children):$,z=a0(Z,z0(m)?m:[m],Y,O,W,G,Q,K,z,N,q),X.base=Y.__e,Y.__u&=-161,X.__h.length&&K.push(X),R&&(X.__E=X.__=null)}catch(g){if(K.length=P,Y.__v=null,N||Q!=null){if(g.then){for(Y.__u|=N?160:128;z&&z.nodeType==8&&z.nextSibling;)z=z.nextSibling;Q!=null&&(Q[Q.indexOf(z)]=null),Y.__e=z}else if(Q!=null)for(s=Q.length;s--;)D0(Q[s])}else Y.__e=O.__e;Y.__k==null&&(Y.__k=O.__k||[]),g.then||i0(Y),M.__e(g,Y,O)}}else Q==null&&Y.__v==O.__v?(Y.__k=O.__k,Y.__e=O.__e):z=Y.__e=M1(O.__e,Y,O,W,G,Q,K,N,q);return($=M.diffed)&&$(Y),128&Y.__u?void 0:z}function i0(Z){Z&&(Z.__c&&(Z.__c.__e=!0),Z.__k&&Z.__k.some(i0))}function o0(Z,Y,O){for(var W=0;W<O.length;W++)w0(O[W],O[++W],O[++W]);M.__c&&M.__c(Y,Z),Z.some(function(G){try{Z=G.__h,G.__h=[],Z.some(function(Q){Q.call(G)})}catch(Q){M.__e(Q,G.__v)}})}function s0(Z){return typeof Z!="object"||Z==null||Z.__b>0?Z:z0(Z)?Z.map(s0):Z.constructor!==void 0?null:h({},Z)}function M1(Z,Y,O,W,G,Q,K,z,N){var q,$,P,X,H,V,U,D=O.props||X0,R=Y.props,F=Y.type;if(F=="svg"?G="http://www.w3.org/2000/svg":F=="math"?G="http://www.w3.org/1998/Math/MathML":G||(G="http://www.w3.org/1999/xhtml"),Q!=null){for(q=0;q<Q.length;q++)if((H=Q[q])&&"setAttribute"in H==!!F&&(F?H.localName==F:H.nodeType==3)){Z=H,Q[q]=null;break}}if(Z==null){if(F==null)return document.createTextNode(R);Z=document.createElementNS(G,F,R.is&&R),z&&(M.__m&&M.__m(Y,Q),z=!1),Q=null}if(F==null)D===R||z&&Z.data==R||(Z.data=R);else{if(Q=F=="textarea"&&R.defaultValue!=null?null:Q&&q0.call(Z.childNodes),!z&&Q!=null)for(D={},q=0;q<Z.attributes.length;q++)D[(H=Z.attributes[q]).name]=H.value;for(q in D)H=D[q],q=="dangerouslySetInnerHTML"?P=H:q=="children"||(q in R)||q=="value"&&("defaultValue"in R)||q=="checked"&&("defaultChecked"in R)||O0(Z,q,null,H,G);for(q in R)H=R[q],q=="children"?X=H:q=="dangerouslySetInnerHTML"?$=H:q=="value"?V=H:q=="checked"?U=H:z&&typeof H!="function"||D[q]===H||O0(Z,q,H,D[q],G);if($)z||P&&($.__html==P.__html||$.__html==Z.innerHTML)||(Z.innerHTML=$.__html),Y.__k=[];else if(P&&(Z.innerHTML=""),a0(Y.type=="template"?Z.content:Z,z0(X)?X:[X],Y,O,W,F=="foreignObject"?"http://www.w3.org/1999/xhtml":G,Q,K,Q?Q[0]:O.__k&&a(O,0),z,N),Q!=null)for(q=Q.length;q--;)D0(Q[q]);z&&F!="textarea"||(q="value",F=="progress"&&V==null?Z.removeAttribute("value"):V!=null&&(V!==Z[q]||F=="progress"&&!V||F=="option"&&V!=D[q])&&O0(Z,q,V,D[q],G),q="checked",U!=null&&U!=Z[q]&&O0(Z,q,U,D[q],G))}return Z}function w0(Z,Y,O){try{if(typeof Z=="function"){var W=typeof Z.__u=="function";W&&Z.__u(),W&&Y==null||(Z.__u=Z(Y))}else Z.current=Y}catch(G){M.__e(G,O)}}function l0(Z,Y,O){var W,G;if(M.unmount&&M.unmount(Z),(W=Z.ref)&&(W.current&&W.current!=Z.__e||w0(W,null,Y)),(W=Z.__c)!=null){if(W.componentWillUnmount)try{W.componentWillUnmount()}catch(Q){M.__e(Q,Y)}W.base=W.__P=W.__n=null}if(W=Z.__k)for(G=0;G<W.length;G++)W[G]&&l0(W[G],Y,O||typeof Z.type!="function");O||D0(Z.__e),Z.__c=Z.__=Z.__e=void 0}function D1(Z,Y,O){return this.constructor(Z,O)}function $0(Z,Y,O){var W,G,Q,K;Y==document&&(Y=document.documentElement),M.__&&M.__(Z,Y),G=(W=typeof O=="function")?null:O&&O.__k||Y.__k,Q=[],K=[],R0(Y,Z=(!W&&O||Y).__k=H0(N0,null,[Z]),G||X0,X0,Y.namespaceURI,!W&&O?[O]:G?null:Y.firstChild?q0.call(Y.childNodes):null,Q,!W&&O?O:G?G.__e:Y.firstChild,W,K),o0(Q,Z,K),Z.props.children=null}q0=G0.slice,M={__e:function(Z,Y,O,W){for(var G,Q,K;Y=Y.__;)if((G=Y.__c)&&!G.__)try{if((Q=G.constructor)&&Q.getDerivedStateFromError!=null&&(G.setState(Q.getDerivedStateFromError(Z)),K=G.__d),G.componentDidCatch!=null&&(G.componentDidCatch(Z,W||{}),K=G.__d),K)return G.__E=G}catch(z){Z=z}throw Z}},d0=0,J1=function(Z){return Z!=null&&Z.constructor===void 0},o.prototype.setState=function(Z,Y){var O;O=this.__s!=null&&this.__s!=this.state?this.__s:this.__s=h({},this.state),typeof Z=="function"&&(Z=Z(h({},O),this.props)),Z&&h(O,Z),Z!=null&&this.__v&&(Y&&this._sb.push(Y),v0(this))},o.prototype.forceUpdate=function(Z){this.__v&&(this.__e=!0,Z&&this.__h.push(Z),v0(this))},o.prototype.render=N0,c=[],h0=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,g0=function(Z,Y){return Z.__v.__b-Y.__v.__b},K0.__r=0,F0=Math.random().toString(8),Q0="__d"+F0,t="__a"+F0,c0=/(PointerCapture)$|Capture$/i,M0=0,T0=f0(!1),_0=f0(!0),P1=0;var e,E,E0,u0,n=0,W1=[],k=M,t0=k.__b,e0=k.__r,n0=k.diffed,Y1=k.__c,Z1=k.unmount,O1=k.__;function y0(Z,Y){k.__h&&k.__h(E,Z,n||Y),n=0;var O=E.__H||(E.__H={__:[],__h:[]});return Z>=O.__.length&&O.__.push({}),O.__[Z]}function T(Z){return n=1,R1(K1,Z)}function R1(Z,Y,O){var W=y0(e++,2);if(W.t=Z,!W.__c&&(W.__=[O?O(Y):K1(void 0,Y),function(z){var N=W.__N?W.__N[0]:W.__[0],q=W.t(N,z);N!==q&&(W.__N=[q,W.__[1]],W.__c.setState({}))}],W.__c=E,!E.__f)){var G=function(z,N,q){if(!W.__c.__H)return!0;var $=!1,P=W.__c.props!==z;if(W.__c.__H.__.some(function(H){if(H.__N){$=!0;var V=H.__[0];H.__=H.__N,H.__N=void 0,V!==H.__[0]&&(P=!0)}}),Q){var X=Q.call(this,z,N,q);return $?X||P:X}return!$||P};E.__f=!0;var{shouldComponentUpdate:Q,componentWillUpdate:K}=E;E.componentWillUpdate=function(z,N,q){if(this.__e){var $=Q;Q=void 0,G(z,N,q),Q=$}K&&K.call(this,z,N,q)},E.shouldComponentUpdate=G}return W.__N||W.__}function r(Z,Y){var O=y0(e++,3);!k.__s&&G1(O.__H,Y)&&(O.__=Z,O.u=Y,E.__H.__h.push(O))}function L0(Z){return n=5,X1(function(){return{current:Z}},[])}function X1(Z,Y){var O=y0(e++,7);return G1(O.__H,Y)&&(O.__=Z(),O.__H=Y,O.__h=Z),O.__}function Y0(Z,Y){return n=8,X1(function(){return Z},Y)}function w1(){for(var Z;Z=W1.shift();){var Y=Z.__H;if(Z.__P&&Y)try{Y.__h.some(B0),Y.__h.some(k0),Y.__h=[]}catch(O){Y.__h=[],k.__e(O,Z.__v)}}}k.__b=function(Z){E=null,t0&&t0(Z)},k.__=function(Z,Y){Z&&Y.__k&&Y.__k.__m&&(Z.__m=Y.__k.__m),O1&&O1(Z,Y)},k.__r=function(Z){e0&&e0(Z),e=0;var Y=(E=Z.__c).__H;Y&&(E0===E?(Y.__h=[],E.__h=[],Y.__.some(function(O){O.__N&&(O.__=O.__N),O.u=O.__N=void 0})):(Y.__h.some(B0),Y.__h.some(k0),Y.__h=[],e=0)),E0=E},k.diffed=function(Z){n0&&n0(Z);var Y=Z.__c;Y&&Y.__H&&(Y.__H.__h.length&&(W1.push(Y)!==1&&u0===k.requestAnimationFrame||((u0=k.requestAnimationFrame)||E1)(w1)),Y.__H.__.some(function(O){O.u&&(O.__H=O.u,O.u=void 0)})),E0=E=null},k.__c=function(Z,Y){Y.some(function(O){try{O.__h.some(B0),O.__h=O.__h.filter(function(W){return!W.__||k0(W)})}catch(W){Y.some(function(G){G.__h&&(G.__h=[])}),Y=[],k.__e(W,O.__v)}}),Y1&&Y1(Z,Y)},k.unmount=function(Z){Z1&&Z1(Z);var Y,O=Z.__c;O&&O.__H&&(O.__H.__.some(function(W){try{B0(W)}catch(G){Y=G}}),O.__H=void 0,Y&&k.__e(Y,O.__v))};var Q1=typeof requestAnimationFrame=="function";function E1(Z){var Y,O=function(){clearTimeout(W),Q1&&cancelAnimationFrame(Y),setTimeout(Z)},W=setTimeout(O,35);Q1&&(Y=requestAnimationFrame(O))}function B0(Z){var Y=E,O=Z.__c;typeof O=="function"&&(Z.__c=void 0,O()),E=Y}function k0(Z){var Y=E;Z.__c=Z.__(),E=Y}function G1(Z,Y){return!Z||Z.length!==Y.length||Y.some(function(O,W){return O!==Z[W]})}function K1(Z,Y){return typeof Y=="function"?Y(Z):Y}var z1=function(Z,Y,O,W){var G;Y[0]=0;for(var Q=1;Q<Y.length;Q++){var K=Y[Q++],z=Y[Q]?(Y[0]|=K?1:2,O[Y[Q++]]):Y[++Q];K===3?W[0]=z:K===4?W[1]=Object.assign(W[1]||{},z):K===5?(W[1]=W[1]||{})[Y[++Q]]=z:K===6?W[1][Y[++Q]]+=z+"":K?(G=Z.apply(z,z1(Z,z,O,["",null])),W.push(G),z[0]?Y[0]|=2:(Y[Q-2]=0,Y[Q]=G)):W.push(z)}return W},q1=new Map;function C0(Z){var Y=q1.get(this);return Y||(Y=new Map,q1.set(this,Y)),(Y=z1(this,Y.get(Z)||(Y.set(Z,Y=function(O){for(var W,G,Q=1,K="",z="",N=[0],q=function(X){Q===1&&(X||(K=K.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?N.push(0,X,K):Q===3&&(X||K)?(N.push(3,X,K),Q=2):Q===2&&K==="..."&&X?N.push(4,X,0):Q===2&&K&&!X?N.push(5,0,!0,K):Q>=5&&((K||!X&&Q===5)&&(N.push(Q,0,K,G),Q=6),X&&(N.push(Q,X,0,G),Q=6)),K=""},$=0;$<O.length;$++){$&&(Q===1&&q(),q($));for(var P=0;P<O[$].length;P++)W=O[$][P],Q===1?W==="<"?(q(),N=[N],Q=3):K+=W:Q===4?K==="--"&&W===">"?(Q=1,K=""):K=W+K[0]:z?W===z?z="":K+=W:W==='"'||W==="'"?z=W:W===">"?(q(),Q=1):Q&&(W==="="?(Q=5,G=K,K=""):W==="/"&&(Q<5||O[$][P+1]===">")?(q(),Q===3&&(N=N[0]),Q=N,(N=N[0]).push(2,0,Q),Q=0):W===" "||W==="\t"||W===`
`||W==="\r"?(q(),Q=2):K+=W),Q===3&&K==="!--"&&(Q=4,N=N[0])}return q(),N}(Z)),Y),arguments,[])).length>1?Y:Y[0]}var J=C0.bind(H0);async function y(Z,Y){let O=await fetch(`/api${Z}`,{credentials:"same-origin",headers:{"Content-Type":"application/json",...Y?.headers??{}},...Y});if(!O.ok){let W=await O.json().catch(()=>({error:O.statusText}));throw Error(W.error||`HTTP ${O.status}`)}return O.json()}function k1(){let[Z,Y]=T([]),[O,W]=T(null),[G,Q]=T("list"),[K,z]=T(null),[N,q]=T(!0),$=Y0(async()=>{try{let H=await y("/agents");Y(H.agents||[])}catch(H){console.error("Failed to load agents:",H)}},[]),P=Y0(async(H)=>{if(!confirm(`Remove "${H.name}"? This deletes its conversation history too.`))return;try{await y(`/agents/${H.id}`,{method:"DELETE"}),W((V)=>{if(V?.id===H.id)return Q("list"),null;return V}),await $()}catch(V){alert(`Failed to remove agent: ${V.message}`)}},[$]);r(()=>{(async()=>{try{let H=await y("/auth/me");z(H.user)}catch{}await $(),q(!1)})()},[]);let X=(H)=>({style:{...H?Object.fromEntries(H.split(";").filter(Boolean).map((V)=>{let[U,D]=V.trim().split(":");return[U.replace(/-([a-z])/g,(R,F)=>F.toUpperCase()),D.trim()]})):{}}});if(N)return J`<div style=${{padding:"2rem",color:"var(--text-dim)"}}>Loading…</div>`;return J`
    <div style=${{display:"flex",height:"100vh",overflow:"hidden"}}>
      ...
      <main style=${{flex:1,overflow:"hidden",display:"flex",flexDirection:"column"}}>
        ${G==="add"&&J`<${j1} onAdded=${(H)=>{$(),W(H),Q("chat")}} />`}
        ${G==="chat"&&O&&J`<${A1} agent=${O} onRefresh=${$} onDelete=${()=>P(O)} />`}
        ${G==="jobs"&&J`<${x1} agents=${Z} />`}
        ${G==="list"&&J`<${y1} />`}
      </main>
    </div>
  ...
  `}var C1={queued:"Queued",provisioning:"Provisioning container…",cloning:"Cloning repo…",running:"Bot is working…",patching:"Applying patch…",opening_pr:"Opening PR…",done:"Done",failed:"Failed"};function x1({agents:Z}){let[Y,O]=T(null),[W,G]=T([]),[Q,K]=T([]),[z,N]=T(""),[q,$]=T(""),[P,X]=T(""),[H,V]=T(!1),[U,D]=T(""),[R,F]=T(null),C=(Z||[]).filter((B)=>B.auth_state==="connected"),v=Y0(async()=>{try{let B=await y("/jobs");K(B.jobs||[])}catch(B){console.error("Failed to load jobs:",B)}},[]);r(()=>{(async()=>{try{let B=await y("/github/status");if(O(B),B.connected){let j=await y("/github/repos");G(j.repos||[])}}catch(B){D(B.message)}await v()})()},[]),r(()=>{if(!Q.some((m)=>!["done","failed"].includes(m.status)))return;let j=setInterval(v,3000);return()=>clearInterval(j)},[Q,v]);async function w(B){if(B?.preventDefault(),!z||!q||!P.trim()||H)return;V(!0),D("");try{let j=await y("/jobs",{method:"POST",body:JSON.stringify({agent_id:z,repo:q,instruction:P.trim()})});K((m)=>[j.job,...m]),X("")}catch(j){D(j.message)}finally{V(!1)}}return J`
      ...
      ${Y?.connected&&J`
        ...
        <form onSubmit=${w} style=${{display:"flex",flexDirection:"column",gap:"1rem",marginBottom:"2rem"}}>
          <div>
            ...
            <select value=${q} onChange=${(B)=>$(B.target.value)} style=${{...i}}>
          ...
          <div>
            ...
            <select value=${z} onChange=${(B)=>N(B.target.value)} style=${{...i}}>
...
Error: ${B.error}`:""}</pre>
  ...
  `}function j1({onAdded:Z}){let[Y,O]=T(""),[W,G]=T(""),[Q,K]=T(""),[z,N]=T(""),[q,$]=T(!1),[P,X]=T(null);async function H(){N(""),X(null),$(!0);try{let V=await y("/agents",{method:"POST",body:JSON.stringify({card_url:Y,oidc_client_id:W,oidc_client_secret:Q})});Z(V.agent)}catch(V){N(V.message)}finally{$(!1)}}return J`
  ...
  `}function A1({agent:Z,onRefresh:Y,onDelete:O}){let[W,G]=T([]),[Q,K]=T(""),[z,N]=T(!1),[q,$]=T(null),[P,X]=T([]),[H,V]=T(""),[U,D]=T(Z),[R,F]=T(!1),C=L0(null),v=L0(null),w=L0(0);r(()=>{y(`/agents/${Z.id}`).then((L)=>D(L)).catch(()=>{})},[Z.id]);let B=Y0(async(L)=>{let _=++w.current;$(L);let x=await y(`/conversations/${L}/messages`);if(_!==w.current)return;G(x.messages||[])},[]);r(()=>{(async()=>{try{let _=(await y(`/agents/${Z.id}/conversations`)).conversations||[];if(X(_),_.length>0)await B(_[0].id);else{let x=++w.current,A=await y(`/agents/${Z.id}/conversations`,{method:"POST"});if(x!==w.current)return;X([A.conversation]),$(A.conversation.id),G([])}}catch(L){V(L.message)}})()},[Z.id]);async function j(){V("");let L=++w.current;try{let _=await y(`/agents/${Z.id}/conversations`,{method:"POST"});if(L!==w.current)return;X((x)=>[_.conversation,...x]),$(_.conversation.id),G([]),K("")}catch(_){if(L===w.current)V(_.message)}}async function m(L){if(L===q)return;V("");try{await B(L)}catch(_){V(_.message)}}r(()=>{C.current?.scrollIntoView({behavior:"smooth"})},[W]);async function s(L){if(L?.preventDefault(),!Q.trim()||!q||z)return;let _=Q.trim(),x=q;K(""),N(!0),V("");let A=++w.current;G((f)=>[...f,{role:"user",text:_,created_at:Date.now()/1000,id:"temp-"+Date.now()}]),G((f)=>[...f,{role:"agent",text:"",created_at:Date.now()/1000,id:"temp-agent-"+Date.now(),streaming:!0}]);try{if(U?.agent_card?.capabilities?.streaming??!0)await S(_,x,A);else await g(_,x,A)}catch(f){if(A===w.current){if(V(f.message),f.message.includes("Authentication"))Y();G((J0)=>J0.filter((l)=>!l.streaming))}}finally{N(!1)}}async function S(L,_,x){let A=await fetch(`/api/conversations/${_}/stream`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({text:L}),credentials:"same-origin"});if(!A.ok){let u=await A.json().catch(()=>({error:A.statusText}));throw Error(u.error||`HTTP ${A.status}`)}let f=A.body.getReader(),J0=new TextDecoder,l="",P0="";while(!0){let{done:u,value:L1}=await f.read();if(u)break;l+=J0.decode(L1,{stream:!0});let A0=l.split(`

`);l=A0.pop()||"";for(let V1 of A0)for(let I0 of V1.split(`
`))if(I0.startsWith("data: "))try{let I=JSON.parse(I0.slice(6));if(I.error)throw Error(I.error);let p="",S0=!1;if(I.task?.status?.message?.parts)p=I.task.status.message.parts.map((d)=>d.text||"").join("");else if(I.message?.parts)p=I.message.parts.map((d)=>d.text||"").join("");else if(I.artifactUpdate?.artifact?.parts)p=I.artifactUpdate.artifact.parts.map((d)=>d.text||"").join(""),S0=!!I.artifactUpdate.append;else if(I.statusUpdate?.status?.message?.parts)p=I.statusUpdate.status.message.parts.map((d)=>d.text||"").join("");if(p){if(P0=S0?P0+p:p,x===w.current)G((d)=>d.map((U0)=>U0.streaming?{...U0,text:P0}:U0))}}catch(I){if(I.message)throw I}}if(x===w.current){let u=await y(`/conversations/${_}/messages`);if(x===w.current)G(u.messages||[])}}async function g(L,_,x){if(await y(`/conversations/${_}/send`,{method:"POST",body:JSON.stringify({text:L})}),x!==w.current)return;let A=await y(`/conversations/${_}/messages`);if(x===w.current)G(A.messages||[])}let[V0,x0]=T(!1),[Z0,H1]=T(""),[j0,N1]=T("");async function $1(){x0(!0),V("");try{await y(`/agents/${Z.id}/credentials`,{method:"POST",body:JSON.stringify({client_id:Z0,client_secret:j0})}),window.location.href=`/api/agents/${Z.id}/connect`}catch(L){V(L.message)}finally{x0(!1)}}let b=U?.auth_state!=="connected",B1=typeof window<"u"?`${window.location.origin}/api/agent/oidc/callback`:"";return J`
      ...
      ${b&&J`
        <div style=${{padding:"1.5rem",borderBottom:"1px solid var(--border)",maxWidth:"600px"}}>
          ...
          <div style=${{padding:"0.6rem",background:"var(--bg)",borderRadius:"8px",marginBottom:"1rem",fontSize:"0.75rem",color:"var(--text-dim)"}}>
            ...
            <br/>
            <code style=${{color:"var(--accent)",fontSize:"0.7rem",wordBreak:"break-all"}}>${B1}</code>
            <br/>
            <a href="https://id.openbao.boxd.sh/settings/admin/oidc-clients" target="_blank" style=${{color:"var(--accent)",fontSize:"0.7rem"}}>
              → Pocket ID admin
            </a>
          </div>
          <button onClick=${$1} disabled=${!Z0||V0} style=${{padding:"0.6rem 1.5rem",borderRadius:"var(--radius)",background:"var(--accent)",color:"white",border:"none",cursor:"pointer",fontWeight:600,fontSize:"0.9rem",opacity:!Z0||V0?0.5:1}}>
  ...
  `}var i={width:"100%",padding:"0.6rem 0.9rem",borderRadius:"var(--radius)",background:"var(--bg-card)",border:"1px solid var(--border)",color:"var(--text)",fontSize:"0.875rem",outline:"none"};$0(J`<${k1} />`,document.getElementById("root"));
